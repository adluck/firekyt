...
import { usePageTour } from "@/components/onboarding/PageTourProvider";
...
export default function Documentation() {
  ...
  const handleQuickStartGuide = () => {
    // Start dashboard tour if on dashboard, otherwise navigate to dashboard and start tour
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      {/* Need Help Section */}
      <Card className="bg-gradient-to-br from-muted/50 to-muted/80 dark:from-muted/20 dark:to-muted/40 border-border">
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              variant="outline" 
              onClick={handleBrowseDocumentation}
      ...
      {/* Tutorial Overview */}
      <Card className="border-primary/20" id="tutorial-content">
        <CardHeader>
