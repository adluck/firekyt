  ...
  return (
    <div className={cn('max-w-7xl mx-auto space-y-6', className)}>
      ...
      <div className={cn(
        ...
        {/* Sidebar */}
        {showSidebar && (
          <div className="space-y-4 sticky top-6 self-start max-h-[calc(100vh-3rem)] overflow-y-auto bg-slate-50/80 dark:bg-slate-900/50 p-4 rounded-lg border border-slate-200 dark:border-slate-700 backdrop-blur-sm">
            {/* Basic Settings */}
