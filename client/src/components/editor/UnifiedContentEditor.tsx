  ...
  return (
    <div className={cn('max-w-7xl mx-auto space-y-6', className)}>
      ...
      <div className={cn(
        ...
        {/* Sidebar */}
        {showSidebar && (
          <div className="space-y-4 sticky top-6 self-start max-h-[calc(100vh-3rem)] overflow-y-auto bg-slate-100 dark:bg-slate-800 p-4 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
            {/* Basic Settings */}
