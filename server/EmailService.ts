...
export class EmailService {
  ...
  private initializeService(): void {
    ...
    try {
      ...
      logger.error('Failed to initialize SendGrid service', error as Error);
    }
  }
  ...
  async sendWelcomeEmail(email: string, username: string): Promise<boolean> {
    ...
    try {
      await sgMail.send(msg);
      logger.info('Welcome email sent successfully', { email: email.replace(/(.{2}).*(@.*)/, '$1***$2') });
      return true;
    } catch (error: any) {
  ...
  private getPasswordResetTemplate(username: string, resetUrl: string): EmailTemplate {
    const subject = 'Reset Your AffiliateAI Password';
...
<head>
  ...
  <style>
    ...
    .warning { background: #fef7e0; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px; }
  </style>
</head>
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>We received a request to reset your password for your AffiliateAI account. If you made this request, click the button below to reset your password:</p>
      ...
      <p>Best regards,<br>The AffiliateAI Team</p>
    </div>
    <div class="footer">
...
We received a request to reset your password for your AffiliateAI account.
...
`;
  ...
  private getWelcomeTemplate(username: string): EmailTemplate {
    const subject = 'Welcome to AffiliateAI! 🚀';
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Welcome to AffiliateAI</title>
  <style>
    body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; }
    .container { max-width: 600px; margin: 0 auto; padding: 20px; }
    .header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px 20px; text-align: center; border-radius: 8px 8px 0 0; }
...
<body>
  <div class="container">
    <div class="header">
      <h1>🚀 Welcome to AffiliateAI!</h1>
    </div>
    <div class="content">
      <p>Hello ${username},</p>
      
      <p>Welcome to AffiliateAI! We're excited to help you create amazing affiliate content that converts.</p>
      
      <h3>Here's what you can do with AffiliateAI:</h3>
      ...
      <p>Happy content creating!<br>The AffiliateAI Team</p>
    </div>
  </div>
</body>
</html>`;
...
Welcome to AffiliateAI! We're excited to help you create amazing affiliate content that converts.

Here's what you can do with AffiliateAI:
